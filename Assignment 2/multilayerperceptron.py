...
#Is this neighborhood good or bad?
...
training_dataset = [row[:-1]+[0 if row[-1]<20 else 1] for row in training_dataset] #Everything above 20 is good and everything below 20 is bad
